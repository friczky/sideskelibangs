        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form action="simpan-inventaris.php" method="POST" class="form-label-left input_mask">
              ...
              <div class="col-md-6 col-sm-6  form-group has-feedback">
                <input type="text" class="form-control has-feedback-left" placeholder="Janis Barang" name="jb">
              ...
              <div class="col-md-6 col-sm-6  form-group has-feedback">
                <input type="text" class="form-control" placeholder="Luas (M2)" name="luas">
              ...
              <div class="col-md-6 col-sm-6  form-group has-feedback">
                <input type="text" class="form-control" placeholder="Type Bangunan" name="type">
