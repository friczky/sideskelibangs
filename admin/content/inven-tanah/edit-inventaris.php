      ...
      <div class="col-md-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <?php 
            $id = $_GET['id'];
            $qCek = mysqli_query($connect, "SELECT * FROM tb_tanah WHERE id_tanah=$id");
            while($row = mysqli_fetch_array($qCek)){
            ?>
            <form action="update-inventaris.php" method="POST" class="form-label-left input_mask">
              <input type="hidden" class="form-control" name="id" value="<?php echo $row['id_tanah'];?>">
              ...
              <div class="col-md-6 col-sm-6  form-group has-feedback">
                <input type="text" class="form-control" placeholder="Luas (M2)" name="luas" value="<?php echo $row['luas_tanah'];?>">
              ...
              <div class="col-md-6 col-sm-6  form-group has-feedback">
                <input type="text" class="form-control" placeholder="Alas Hak/Bukti Kepemilikan" name="bk" value="<?php echo $row['bukti'];?>">
