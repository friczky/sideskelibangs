      ...
      <div class="col-md-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <?php 
            $id = $_GET['id'];
            $qCek = mysqli_query($connect, "SELECT * FROM tb_inven_tetap WHERE id_inven_tetap=$id");
            while($row = mysqli_fetch_array($qCek)){
            ?>
            <form action="update-inventaris.php" method="POST" class="form-label-left input_mask">
              <input type="hidden" class="form-control" name="id" value="<?php echo $row['id_inven_tetap'];?>">
