...
$qUpdate = mysqli_query($connect, "UPDATE tb_inven_tetap SET tanggal='$tanggal',nama_barang='$nama_barang',kode_barang='$kode_barang',nup='$nup',tahun_perolehan='$tahun_perolehan',merk='$merk',nilai='$nilai_perolehan',keterangan='$keterangan' WHERE id_inven_tetap='$id'");
