...
$qUpdate = mysqli_query($connect, "UPDATE tb_inven_pm SET tanggal='$tanggal',nama_barang='$nama_barang',kode_barang='$kode_barang',nup='$nup',merk='$merk',tahun_perolehan='$tahun_perolehan',nilai='$nilai_perolehan',kondisi='$kondisi',keterangan='$keterangan' WHERE id_pm='$id'");
