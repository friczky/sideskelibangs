        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <div class="col-md-12 col-sm-12  form-group has-feedback">
                ...
                <p>8. Diisi kondisi barang (B/baik, RR/rusak ringan, RB/rusak berat)</p>
                <p>9. Diisi keterangan yang menjelaskan barang tersebut ( pemakai/tidak diketemukan/hilang dll) yang dianggap perlu</p>
              </div>
          </div>
        </div>
      </div>
