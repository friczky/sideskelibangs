      ...
      <div class="col-md-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <?php 
            $id = $_GET['id'];
            $qCek = mysqli_query($connect, "SELECT * FROM tb_inven_kb WHERE id_kb=$id");
            while($row = mysqli_fetch_array($qCek)){
            ?>
            <form action="update-inventaris.php" method="POST" class="form-label-left input_mask">
              <input type="hidden" class="form-control" name="id" value="<?php echo $row['id_kb'];?>">
              ...
              <div class="col-md-6 col-sm-6  form-group has-feedback">
                <input type="text" class="form-control" placeholder="No Polisi" name="nopol" value="<?php echo $row['nopol'];?>">
                <span class="fa fa-th-large form-control-feedback right" aria-hidden="true"></span>
              </div>

              <div class="col-md-6 col-sm-6  form-group has-feedback">
                <input type="text" class="form-control has-feedback-left" placeholder="No Mesin" name="noMesin" value="<?php echo $row['nomesin'];?>">
                <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
              </div>

              <div class="col-md-6 col-sm-6  form-group has-feedback">
                <input type="text" class="form-control" placeholder="No BPKP" name="noBpkb" value="<?php echo $row['nobpkb'];?>">
                <span class="fa fa-th-large form-control-feedback right" aria-hidden="true"></span>
              </div>

              <div class="col-md-6 col-sm-6  form-group has-feedback">
                <input type="text" class="form-control has-feedback-left" placeholder="No Rangka" name="noRangka" value="<?php echo $row['norangka'];?>">
                <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
              </div>
